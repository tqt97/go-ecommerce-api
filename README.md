...
Dự án sử dụng các công nghệ hiện đại để đảm bảo hiệu suất cao:
- **Ngôn ngữ**: [Golang](https://go.dev/) (v1.22+)
- **Web Framework**: [Gin Gonic](https://gin-gonic.com/) - High performance HTTP web framework.
- **Database**: MySQL/PostgreSQL (GORM - *Sắp tới*).
- **Logger**: Uber-zap.
...
2. Cài đặt các thư viện:
   ...
   ```bash
   # Tải toàn bộ dependencies
   go mod tidy

   # Lệnh cài đặt Gin Framework (nếu bắt đầu từ đầu)
